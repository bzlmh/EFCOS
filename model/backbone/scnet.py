...
model_urls = {
    ...
    'scnet50_v1d': 'https://backseason.oss-cn-beijing.aliyuncs.com/scnet/dscnet50_v1-4109d1e1.pth',
...
class SCNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilation=1, norm_layer=None, is_first=True):
        ...
        for i in range(1, blocks):
            layers.append(block(self.inplanes, planes, cardinality=self.cardinality, bottleneck_width=self.bottleneck_width, avd=self.avd, dilation=dilation, norm_layer=norm_layer))
